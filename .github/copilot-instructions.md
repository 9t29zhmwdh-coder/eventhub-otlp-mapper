# Copilot Instructions for eventhub-otlp-mapper
A Python command-line consumer that maps Azure EventHub messages (JSON, Avro, or Protobuf) to OpenTelemetry traces and metrics via declarative YAML field mapping, then exports them over OTLP to Grafana, Application Insights, Prometheus, or any OTLP-compatible backend.
